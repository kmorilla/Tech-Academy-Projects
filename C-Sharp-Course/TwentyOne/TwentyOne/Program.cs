    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!validAnswer)
            {
                ...
                if (!validAnswer) Console.WriteLine("Please enter digits onlyl, no decimals.");
            }
            ...
            if (answer == "yes" || answer == "yeah" || answer == "y" || answer == "ya")
            {
                ...
                using (StreamWriter file = new StreamWriter(@"D:\The Tech Academy\C#\TwentyOne\log.txt", true))
                {
